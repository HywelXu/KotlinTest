...
public class AndroidTools {
    ...
    public static String getDisplay(Context context) {
        String display = getScreenWidth(context) + "*" + getScreenHeight(context);
        ;
        return display;
    }
        ...
        (new Handler()).postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                view.dispatchTouchEvent(MotionEvent.obtain(SystemClock.uptimeMillis(),
                        SystemClock.uptimeMillis(), MotionEvent.ACTION_DOWN, xOffset, 0, 0));
                view.dispatchTouchEvent(MotionEvent.obtain(SystemClock.uptimeMillis(),
                        SystemClock.uptimeMillis(), MotionEvent.ACTION_UP, xOffset, 0, 0));
